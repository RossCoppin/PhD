...
*Figure 2: Coastal wave energy exposure around the Cape Peninsula for the total 17-year nearshore wave record, (b) only winter months and (c) only summer months. *
...
*Figure 3: SWAN numerical output for an example typical offshore wave conditions refracting around the Cape Peninsula.  *
