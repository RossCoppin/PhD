...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Wave roses of the Cape Point wave rider buoy situated at 18.29oE, 34.2oS in 70m water depth. (a) total wave record, (b) winter waves and (c) summer waves."}
...
grid.arrange(img_twr, img_wwr,img_swr, ncol = 3)
