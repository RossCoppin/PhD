...
```{r Temperature variables plot, echo=FALSE, warning=FALSE, fig.cap="Temperature variables at the collection sites around the Cape Peninsula. Temperature variables include minimum represented by blue dots.", fig.height=8, fig.width=8}
...
```{r wave variable plot, warming = FALSE, echo=FALSE, message = FALSE, include= TRUE, fig.cap='Wave variables at each collection site around the Western Cape coast. Mean variables are represented by dots and standard deviation by whiskers.', fig.height=8, fig.width=8}
...
```{r laminaria temp plots, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=9, fig.cap='Boxplot of morphological characteristics for *L. pallida* categorised by temperature regime.'}
...
```{r laminaria wave plots, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=9, fig.cap ='Boxplot of morphological characteristics for *L. pallida* categorised by wave exposure.'}
...
```{r deep ecklonia temp plots, echo=FALSE, message=TRUE, warning=FALSE, fig.height=9, fig.width=9, fig.cap ='Boxplot of morphological characteristics for deep population *E. maxima* categorised by temperature regime.'}
ggarrange(ET1,ET2,ET3,ET4,ET5,ET6,ET7,ET8,ET9,ET10, labels = "AUTO", common.legend = TRUE, legend = "bottom")
```

```{r deep ecklonia wave plots, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=9, fig.cap = 'Boxplot of morphological characteristics for deep population *E. maxima* categorised by wave exposure.'}
ggarrange(EW1,EW2,EW3,EW4,EW5,EW6,EW7,EW8, EW9, EW10,labels = "AUTO", common.legend = TRUE, legend = "bottom")
```

```{r shallow ecklonia temp processing, message=FALSE, warning=FALSE, include=FALSE, echo=FALSE}
...
```{r shallow ecklonia wave processing, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r shallow ecklonia temp plots, echo=FALSE, message=TRUE, warning=FALSE, fig.height=9, fig.width=9, fig.cap ='Boxplot of morphological characteristics for shallow population *E. maxima* categorised by temperature regime.'}
ggarrange(EST1,EST2,EST3,EST4,EST5,EST6,EST7,EST8,EST9,EST10, labels = "AUTO", common.legend = TRUE, legend = "bottom")
```

```{r shallow eck wave plot, message=FALSE,warning=FALSE,include=TRUE, fig.height=9, fig.width=9 ,fig.cap = 'Boxplot of morphological characteristics for shallow population *E. maxima* categorised by wave exposure.'}
ggarrange(ESW1,ESW2,ESW3,ESW4,ESW5,ESW6,ESW7,ESW8, ESW9, ESW10,labels = "AUTO", common.legend = TRUE, legend = "bottom")
```
