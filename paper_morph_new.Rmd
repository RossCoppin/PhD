...
pos_lam <- c("Betty's Bay", "Roman Rock","A-Frame", "Miller's Point", "Baboon Rock", 
                  "Batsata Rock", "Buffels Bay"," Buffels Bay South","Bordjies North","Olifantsbos", "Kommetjie", "Sea Point")
pos_exposure_lam <- c("Fully sheltered", "Extremely sheltered", "Very sheltered", "Sheltered", "Moderatley exposed", "Exposed", "Very exposed")

lamina_weight_plot <- ggplot(data = lam_df, aes(x = wave_exposure, y = laminaWeight, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure_lam) + 
         geom_boxplot(outlier.shape = NA) 
lamina_length_plot <- ggplot(data = lam_df, aes(x = wave_exposure, y = laminaLength, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure_lam) + 
         geom_boxplot(outlier.shape = NA) 
lamina_thickness_plot <- ggplot(data = lam_df, aes(x = wave_exposure, y = laminaThickness, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure_lam) + 
         geom_boxplot(outlier.shape = NA) 
stipe_mass_lam_plot <- ggplot(data = lam_df, aes(x = wave_exposure, y = stipeMass, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure_lam) + 
         geom_boxplot(outlier.shape = NA) 
stipe_length_lam_plot <- ggplot(data = lam_df, aes(x = wave_exposure, y = stipeLength, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure_lam) + 
         geom_boxplot(outlier.shape = NA) 
stipe_diameter_plot <- ggplot(data = lam_df, aes(x = wave_exposure, y = stipeDiameter, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure_lam) + 
         geom_boxplot(outlier.shape = NA) 
digits_plot <- ggplot(data = lam_df, aes(x = wave_exposure, y = digits, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure_lam) + 
         geom_boxplot(outlier.shape = NA) 
thallus_mass_plot <- ggplot(data = lam_df, aes(x = wave_exposure, y = thallusMass, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure_lam) + 
         geom_boxplot(outlier.shape = NA) 
total_length_plot <- ggplot(data = lam_df, aes(x = wave_exposure, y = totalLength, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure_lam) + 
         geom_boxplot(outlier.shape = NA) 
```

```{r laminaria plots, echo=FALSE, message=FALSE, warning=FALSE}
grid.arrange(lamina_weight_plot,lamina_length_plot,lamina_thickness_plot,stipe_mass_lam_plot,stipe_length_lam_plot,stipe_diameter_plot, digits_plot, thallus_mass_plot,total_length_plot,total_length_plot, ncol = 3, nrow = 4)
