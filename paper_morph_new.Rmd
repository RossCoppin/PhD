...
```{r software packages, message=TRUE, warning=TRUE, include=FALSE, echo=FALSE}
library(tidyverse)
library(ggpubr)
library(gridExtra)
```
...
```{r Temperature variables plot, echo=FALSE, warning=FALSE, fig.cap="Temperature variables at the collection sites around the Cape Peninsula. Temperature variables include minimum represented by blue dots.", fig.height=9, fig.width=7}
...
```{r wave data prep, message=FALSE, warning=FALSE, include=FALSE}
...
```{r wave variable processing, warning=FALSE, include=FALSE, echo = FALSE}
...
```{r wave variable plot, warming = FALSE, echo=FALSE, message = FALSE, include= TRUE, fig.cap='Wave variables at each collection site around the Western Cape coast. Mean variables are represented by dots and standard deviation by whiskers. Plot "A" represents annual significant wave height.', fig.height=8, fig.width=7}
...
```{r laminaria processing, message=FALSE, warning=FALSE, include=FALSE}
lam_data <- read.csv("data/morph_data/lam_morph_data.csv", sep = ";") %>% 
   filter(site!= "Rocky Bank")
...
pos_lam_temp <- c("Cool temperate", "Warm temperate")
  
LT1 <- ggplot(data = lam_df, aes(x = temp_regime, y = laminaWeight, fill = temp_regime)) +
  scale_x_discrete(limits = pos_lam_temp) + 
...
LT2 <- ggplot(data = lam_df, aes(x = temp_regime, y = laminaLength, fill = temp_regime)) +
  scale_x_discrete(limits = pos_lam_temp)  + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = FALSE) + 
  stat_compare_means() + 
  xlab("") + 
  ...
  theme(axis.title.x=element_blank(),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank())
LT3 <- ggplot(data = lam_df, aes(x = temp_regime, y = laminaThickness, fill = temp_regime)) +
  scale_x_discrete(limits = pos_lam_temp) + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = FALSE) + 
  stat_compare_means() + 
  xlab("") + 
  ...
  theme(axis.title.x=element_blank(),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank())
LT4 <- ggplot(data = lam_df, aes(x = temp_regime, y = stipeMass, fill = temp_regime)) +
  scale_x_discrete(limits = pos_lam_temp)  + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = FALSE) + 
  stat_compare_means() + 
  xlab("") + 
  ...
  theme(axis.title.x=element_blank(),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank())
LT5 <- ggplot(data = lam_df, aes(x = temp_regime, y = stipeLength, fill = temp_regime)) +
  scale_x_discrete(limits = pos_lam_temp)  + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = FALSE) + 
  stat_compare_means() + 
  xlab("") + 
  ...
  theme(axis.title.x=element_blank(),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank())
LT6 <- ggplot(data = lam_df, aes(x = temp_regime, y = stipeDiameter, fill = temp_regime)) +
  scale_x_discrete(limits = pos_lam_temp)  + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = FALSE) + 
  stat_compare_means() + 
  xlab("") + 
  ...
  theme(axis.title.x=element_blank(),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank())
LT7 <- ggplot(data = lam_df, aes(x = temp_regime, y = digits, fill = temp_regime)) +
  scale_x_discrete(limits = pos_lam_temp)  + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = FALSE) + 
  stat_compare_means() + 
  xlab("") + 
  ...
  theme(axis.title.x=element_blank(),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank())
LT8 <- ggplot(data = lam_df, aes(x = temp_regime, y = thallusMass, fill = temp_regime)) +
  scale_x_discrete(limits = pos_lam_temp) + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = FALSE) + 
  stat_compare_means() + 
  xlab("") + 
  ...
  theme(axis.title.x=element_blank(),
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank())
LT9 <- ggplot(data = lam_df, aes(x = temp_regime, y = totalLength, fill = temp_regime)) +
  scale_x_discrete(limits = pos_lam_temp) + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = FALSE) + 
  stat_compare_means() + 
  xlab("") + 
...
lam_df$wave_exposure <- factor(lam_df$wave_exposure, levels=c("Very sheltered", "Very exposed", "Moderately exposed","Fully sheltered","Extremely sheltered"), labels=c("Fully sheltered", "Extremely sheltered", "Very sheltered", "Moderately exposed", "Very exposed"))
pos_exposure_lam <- c("Fully sheltered", "Extremely sheltered", "Very sheltered", "Moderately exposed", "Very exposed")

LW1 <- ggplot(data = lam_df, aes(x = wave_exposure, y = laminaWeight, fill = wave_exposure)) +
...
LW2 <- ggplot(data = lam_df, aes(x = wave_exposure, y = laminaLength, fill = wave_exposure)) +
  scale_x_discrete(limits = pos_exposure_lam)  + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
  ...
  scale_fill_brewer(palette="OrRd") +
  guides(fill=guide_legend(title="Wave exposure level"))
LW3 <- ggplot(data = lam_df, aes(x = wave_exposure, y = laminaThickness, fill = wave_exposure)) +
  scale_x_discrete(limits = pos_exposure_lam) + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
  ...
  scale_fill_brewer(palette="OrRd") +
  guides(fill=guide_legend(title="Wave exposure level")) 
LW4 <- ggplot(data = lam_df, aes(x = wave_exposure, y = stipeMass, fill = wave_exposure)) +
  scale_x_discrete(limits = pos_exposure_lam)  + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
  ...
  scale_fill_brewer(palette="OrRd") +
  guides(fill=guide_legend(title="Wave exposure level")) 
LW5 <- ggplot(data = lam_df, aes(x = wave_exposure, y = stipeLength, fill = wave_exposure)) +
  scale_x_discrete(limits = pos_exposure_lam)  + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
  ...
  scale_fill_brewer(palette="OrRd") +
  guides(fill=guide_legend(title="Wave exposure level")) 
LW6 <- ggplot(data = lam_df, aes(x = wave_exposure, y = stipeDiameter, fill = wave_exposure)) +
  scale_x_discrete(limits = pos_exposure_lam)  + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
  ...
  scale_fill_brewer(palette="OrRd") +
  guides(fill=guide_legend(title="Wave exposure level")) 
LW7 <- ggplot(data = lam_df, aes(x = wave_exposure, y = digits, fill = wave_exposure)) +
  scale_x_discrete(limits = pos_exposure_lam)  + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
  ...
  scale_fill_brewer(palette="OrRd") +
  guides(fill=guide_legend(title="Wave exposure level")) 
LW8 <- ggplot(data = lam_df, aes(x = wave_exposure, y = thallusMass, fill = wave_exposure)) +
  scale_x_discrete(limits = pos_exposure_lam) + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
  ...
  scale_fill_brewer(palette="OrRd") +
  guides(fill=guide_legend(title="Wave exposure level")) 
LW9 <- ggplot(data = lam_df, aes(x = wave_exposure, y = totalLength, fill = wave_exposure)) +
  scale_x_discrete(limits = pos_exposure_lam) + 
  geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
...
```{r laminaria temp plots, echo=FALSE, message=FALSE, warning=FALSE}
ggarrange(LT1, LT2,LT3,LT4,LT5,LT6,LT7,LT8,LT9, labels = c('A', 'B', 'C','D','E','F','G','H',"I"), common.legend = TRUE, legend = "bottom", label = "p.format", ncol = 3, nrow = 3)
```


```{r laminaria wave plots, echo=FALSE, message=FALSE, warning=FALSE}
ggarrange(LW1, LW2,LW3,LW4,LW5,LW6,LW7,LW8,LW9, labels = c('A', 'B', 'C','D','E','F','G','H',"I"), common.legend = TRUE, legend = "bottom")
```

### *E.maxima*

```{r ecklonia  processing, message=FALSE, warning=FALSE, include=FALSE}
...
pos_exposure <- c("Fully sheltered", "Extremely sheltered", "Very sheltered", "Sheltered", "Moderatley exposed", "Exposed", "Very exposed")
pos_eck<- c("Betty's Bay", "Kalk Bay", "A-Frame",  "Miller's Point", "Baboon Rock", "Batsata Rock", "Buffelsbaai", "Scarborough", "Soetwater","Kommetjie","Hout Bay", "Oudekraal", "St Helena Bay")

frond_mass_plot <- ggplot(data = eck_deep, aes(x = wave_exposure, y = frond_mass, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure) + 
         geom_boxplot(outlier.shape = NA) 
primary_length_plot <- ggplot(data = eck_deep, aes(x = wave_exposure, y = primary_length, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure) + 
         geom_boxplot(outlier.shape = NA) 
primary_width_plot <- ggplot(data = eck_deep, aes(x = wave_exposure, y = primary_width, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure) + 
         geom_boxplot(outlier.shape = NA) 
frond_length_plot <- ggplot(data = eck_deep, aes(x = wave_exposure, y = frond_length, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure) + 
         geom_boxplot(outlier.shape = NA) 
stipe_mass_plot <- ggplot(data = eck_deep, aes(x = wave_exposure, y = stipe_mass, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure) + 
         geom_boxplot(outlier.shape = NA) 
stipe_length_plot <- ggplot(data = eck_deep, aes(x = wave_exposure, y = stipe_length, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure) + 
         geom_boxplot(outlier.shape = NA) 
stipe_circ_plot <- ggplot(data = eck_deep, aes(x = wave_exposure, y = stipe_circ, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure) + 
         geom_boxplot(outlier.shape = NA) 
tufts_plot <- ggplot(data = eck_deep, aes(x = wave_exposure, y = tufts, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure) + 
         geom_boxplot(outlier.shape = NA) 
epi_length_plot <- ggplot(data = eck_deep, aes(x = wave_exposure, y = epi_length, fill = wave_exposure)) +
         scale_x_discrete(limits = pos_exposure) + 
         geom_boxplot(outlier.shape = NA) 
total_length_plot <- ggplot(data = eck_deep, aes(x = wave_exposure, y = total_length, fill = wave_exposure)) +
  scale_x_discrete(limits = pos_exposure) + 
  geom_boxplot(outlier.shape = NA) +
  ylim(0, 2000)
...
```{r ecklonia plots, echo=FALSE, message=FALSE, warning=FALSE}

grid.arrange(frond_mass_plot,primary_length_plot,primary_width_plot,frond_length_plot,stipe_mass_plot,stipe_length_plot,stipe_circ_plot, tufts_plot, epi_length_plot,total_length_plot, ncol = 3, nrow = 4)
