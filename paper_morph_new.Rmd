...
```{r laminaria plots, echo=FALSE, fig.cap='Boxplots of *L. pallida morphological characteristics group by temperature regime and wave exposure category.', fig.height=8, fig.width=8, message=FALSE, warning=FALSE, include=FALSE}

ggarrange(LT1, LT2,LT3,LT4,LT5,LT6,LT7,LT8,LT9, labels = c('A', 'B', 'C','D','E','F','G','H',"I"), common.legend = TRUE, legend = "bottom")
...
```{r deep ecklonia  plots, echo=FALSE, message=TRUE, warning=FALSE, fig.height=8, fig.width=8, fig.cap ='Boxplot of morphological characteristics for deep population *E. maxima* grouped by temperature regime and wave exposure.'}
...
```{r shallow ecklonia temp plots, echo=FALSE, message=TRUE, warning=FALSE, fig.height=8, fig.width=8, fig.cap ='Boxplot of morphological characteristics for shallow population *E. maxima* grouped by temperature regime and wave exposure.'}
