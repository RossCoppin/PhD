...
```{r map, echo=FALSE, fig.height=8, fig.width=8, message=FALSE, warning=FALSE, fig.cap="\\label{fig:map}Map of the study area and sampling sites. The red dot indicates the position of Cape Town for sake of reference."}
map_combined
```
...
```{r wave rose, echo=FALSE, warning = FALSE, eval= TRUE, fig.align="center",fig.cap='\\label{fig:wave rose}The total and seasonal wave roses of the directional wave buoy just offshore from Cape Town is given form the years 2000 till end 2017 (the period for which directional wave spectra was available). Total (A), Austral winter (B) and Austral summer (C) respectively'}
...
ggarrange(img_wave_rose_A, img_wave_rose_B, img_wave_rose_C, ncol = 2, nrow = 2, labels = "AUTO")
```

```{r wave power map, echo=FALSE, eval= TRUE, fig.cap='\\label{fig:wave power map}The total coastal wave exposure of the Cape Peninsula is given in terms of wave energy (kW per meter wave crest length. Total (A), summer (B), winter (C), spring (D) and autumn (E).'}
...
wp_1 <- rasterGrob(as.raster(readJPEG("figures/chapter_2/fig_6A.jpg"))) #figure missing, copy of fig_6B used
wp_2 <- rasterGrob(as.raster(readJPEG("figures/chapter_2/fig_6B.jpg")))
wp_3 <- rasterGrob(as.raster(readJPEG("figures/chapter_2/fig_6C.jpg")))
wp_4 <- rasterGrob(as.raster(readJPEG("figures/chapter_2/fig_6D.jpg")))
wp_5 <- rasterGrob(as.raster(readJPEG("figures/chapter_2/fig_6E.jpg")))
wp_6 <- rasterGrob(as.raster(readJPEG("figures/chapter_2/fig_6_legend.jpg")))

ggarrange(wp_1, wp_2, wp_3, wp_4, wp_5, wp_6, ncol = 3, nrow = 2, labels = "AUTO", align = "hv")
...
img_fb <- readJPEG("figures/chapter_2/fig_7.jpg")
grid.raster(img_fb)
...
ggarrange(ET1,ET2,ET3,ET4,ET5,ET6,ET7,ET8,ET9,ET10, labels = "AUTO", common.legend = TRUE, legend = c("none"), ncol = 4, nrow = 3, vjust = 1.5)
```
...
ggarrange(EW1,EW2,EW3,EW4,EW5,EW6,EW7,EW8,EW9,EW10, labels = "AUTO", common.legend = TRUE, legend = "bottom", ncol = 4, nrow = 3, vjust = 1.5)
```
...
ggarrange(EST1,EST2,EST3,EST4,EST5,EST6,EST7,EST8,EST9,EST10, labels = "AUTO", common.legend = FALSE, legend = "bottom", ncol = 4, nrow = 3, vjust = 1.5)
```
...
ggarrange(ESW1,ESW2,ESW3,ESW4,ESW5,ESW6,ESW7,ESW8, ESW9,ESW10, labels = "AUTO", common.legend = TRUE, legend = "bottom", ncol = 4,nrow = 3)
```
...
rda_1 <- rasterGrob(as.raster(readJPEG("thesis_chapter_2_files/figures_frontiers/fig_12A.jpeg"))) #figure missing, copy of fig_6B used
rda_2 <- rasterGrob(as.raster(readJPEG("thesis_chapter_2_files/figures_frontiers/fig_12B.jpeg")))
rda_3 <- rasterGrob(as.raster(readJPEG("thesis_chapter_2_files/figures_frontiers/fig_12C.jpeg")))
