...
geom_polygon(data = south_africa_coast_hi_res, aes(x = lon, y = lat, group = PID),
  ...
  geom_point(data = study_sites, aes(x = lon, y = lat), color = "red", nudge_x = 0, nudge_y = 0) +
  geom_label(data = study_sites_edit, aes(x = lon, y = lat, label = site), nudge_x = -0.02, nudge_y = 0.1) +
