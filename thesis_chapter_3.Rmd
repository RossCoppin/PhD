...
Mean_KFloat_H085_W15$type <- "Mean_KFloat_H090_W10" # add extra column 'type' to dataframe and assigned 'kelp' label

total_data <- rbind(p_RK4, Mean_Kfloat_H100_W00, Mean_KFloat_H095_W05, Mean_KFloat_H090_W10, Mean_KFloat_H085_W15)
...
library(ggpubr)
ggarrange(heatmap_RK4, heatmap_Mean_Kfloat_H100_W00, heatmap_Mean_KFloat_H095_W05, heatmap_Mean_KFloat_H090_W10, heatmap_Mean_KFloat_H085_W15, labels = c("A","B","C","D", "E"), common.legend = TRUE, legend = c("right"), ncol = 2, nrow = 3)

```

```{r scatter plot processing, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r age plots, warning=FALSE, echo=FALSE, include=TRUE, message=FALSE, eval=FALSE}
...
```{r morphology_wrangling, eval=TRUE, message=FALSE, warning=FALSE, include=TRUE}
