...
fieldUend <- rasterGrob(as.raster(readJPEG("OceanParcels/trajectory_data/fieldUend.jpg")))
fieldVend <- rasterGrob(as.raster(readJPEG("OceanParcels/trajectory_data/fieldVend.jpg")))
windUend <- rasterGrob(as.raster(readJPEG("OceanParcels/trajectory_data/windUend.jpg")))
windUend <- rasterGrob(as.raster(readJPEG("OceanParcels/trajectory_data/windVend.jpg")))

ggarrange(fieldUend, fieldVend, windUend, windUend, ncol = 2, nrow = 2, labels = "AUTO")
```
...
ggarrange(shape_plot, shape_dis_plot, heatmap_Max_KFloat_H100_W00, heatmap_Max_ShapeFloat_H100_W00, labels = c("AUTO"), common.legend = TRUE, legend = c("bottom"), ncol = 2, nrow = 2)
