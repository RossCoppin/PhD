...
wwdrag_plot_Oct <- ggplot() +
  ...
  theme(plot.title = element_text(hjust = 0.5)) +
  #coord_fixed(ratio=1/1, clip = "on") + # fix the aspect ratio of plot
  theme_bw() 
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Figure 6: Comparison of density plots at the end of the run for scenarios 40 - 52, for October 2018 (spring). See Figure 4 for further details.', fig.height=8, fig.width=8}
