...
In order to determine if the shape co-efficient used plays a role in model used and to validate the use of a sphereical shape coefficent, simulations of kelps with the maximum surface area and hydrodynamic drag exposure was run using the shape coefficient for a cylinder to compare to a simulations using a spheres. Simulations were run for 30 days using a fourth order Runge-Kutte advection scheme with brownian motion and a particle set of size 1000 for the same seasons as per previous simulations. 
