...
```{r sim table, eval=TRUE, message=FALSE, warning=FALSE, include=FALSE}
...
Min_Kfloat_H100_W00_mean_Oct$type <- "40" # add extra column 'type' to dataframe and assigned 'kelp' label
...
Min_Kfloat_H095_W05_mean_Oct$type <- "41" # add extra column 'type' to dataframe and assigned 'kelp' label
...
Min_Kfloat_H090_W10_mean_Oct$type <- "42" # add extra column 'type' to dataframe and assigned 'kelp' label
...
Min_Kfloat_H085_W15_mean_Oct$type <- "43" # add extra column 'type' to dataframe and assigned 'kelp' label
...
Mean_Kfloat_H100_W00_mean_Oct$type <- "44" # add extra column 'type' to dataframe and assigned 'kelp' label
...
Mean_KFloat_H095_W05_mean_Oct$type <- "45" # add extra column 'type' to dataframe and assigned 'kelp' label
...
Mean_KFloat_H090_W10_mean_Oct$type <- "46" # add extra column 'type' to dataframe and assigned 'kelp' label
...
Mean_KFloat_H085_W15_mean_Oct$type <- "47" # add extra column 'type' to dataframe and assigned 'kelp' label
...
Max_Kfloat_H100_W00_mean_Oct$type <- "48" # add extra column 'type' to dataframe and assigned 'kelp' label
...
Max_Kfloat_H095_W05_mean_Oct$type <- "49" # add extra column 'type' to dataframe and assigned 'kelp' label
...
Max_Kfloat_H090_W10_mean_Oct$type <- "50" # add extra column 'type' to dataframe and assigned 'kelp' label
...
Max_Kfloat_H085_W15_mean_Oct$type <- "51" # add extra column 'type' to dataframe and assigned 'kelp' label
...
```{r shape data outputs, warning=FALSE, echo=FALSE, message=FALSE, fig.cap="Figure 9: Comparison of trajectory data between spehere and cylinder shape coeficients for scenarios 61-64.The mean trajectory comparison between passive and kel The reader is referred to tables 1 and 2 for details pertaining to each scenario.", fig.height=10, fig.width=8}
