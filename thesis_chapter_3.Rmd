...
ggarrange(waterdrag_plot, wwdrag_plot, waterdrag_plot_April, wwdrag_plot_April, waterdrag_plot_July, wwdrag_plot_July, waterdrag_plot_Oct, wwdrag_plot_Oct, ncol = 2, nrow = 4, font.label = list(size = 11, face = "bold"), common.legend = FALSE, legend = c("bottom"), labels = "AUTO", align = "hv")
```
...
heatmap_RK4_acc <- ggplot() +
  ...
  guides(fill=guide_legend(title="Number of particles")) +
  coord_fixed(ratio=1/1, xlim = c(11, 20), ylim = c(-36, -26)) + # fix the aspect ratio of plot
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
