...
```{r scatter advection, message=FALSE, warning=FALSE, include=TRUE, echo=FALSE}

total_traj <- ggplot(data = total_data, aes(x = lon, y = lat, colour = type)) + 
  geom_point(aes(alpha = 0.2)) + 
  xlab("Longtitude") + 
  ylab("Latitude") + 
  theme_bw() +
  guides(colour=guide_legend(title="Particle type"))
total_traj
...
## 2D histogram plots of number of particles

bin_RK4 <- ggplot(p_RK4, aes(x=lon, y=lat)) +
  geom_bin2d(bins = 20) +
...
bin_RK4 <- ggplot(p_EE, aes(x=lon, y=lat)) +
  geom_bin2d(bins = 20) +
  scale_fill_continuous(type = "viridis") +
  coord_fixed() +
  xlab("Longtitude") + 
...
bin_APP1 <- ggplot(k_app1, aes(x=lon, y=lat)) +
  geom_bin2d(bins = 20) +
  scale_fill_continuous(type = "viridis") +
  coord_fixed() +
  xlab("Longtitude") + 
...
bin_APP2 <- ggplot(k_app2, aes(x=lon, y=lat)) +
  geom_bin2d(bins = 20) +
  scale_fill_continuous(type = "viridis") +
  coord_fixed() +
  xlab("Longtitude") + 
...
library(ggpubr)
ggarrange(heatmap_RK4, heatmap_EE, heatmap_APP1, heatmap_APP2, labels = c("A","B","C","D"), common.legend = TRUE, legend = c("right"))
