...
```{r eddy plots, message=FALSE, warning=FALSE, include=FALSE}

passive_eddy <- ggplot() + 
  geom_point(data = p_eddy, aes(x = lon, y = lat)) +
  xlab("Longtitude") + 
  ylab("Latitude") + 
  ggtitle("Passive") + 
  theme_bw() +
...
min_eddy <- ggplot() + 
  geom_point(data = Min_K_Eddy, aes(x = lon, y = lat)) +
  xlab("Longtitude") + 
  ylab("Latitude") + 
  ggtitle("Minimum Ac") + 
  theme_bw() +
...
mean_eddy <- ggplot() + 
  geom_point(data = Mean_KFloat_Eddy, aes(x = lon, y = lat)) +
  xlab("Longtitude") + 
  ylab("Latitude") + 
  ggtitle("Mean Ac") + 
  theme_bw() +
...
max_eddy <- ggplot() + 
  geom_point(data = Max_KFloat_Eddy, aes(x = lon, y = lat)) +
  xlab("Longtitude") + 
  ylab("Latitude") +
  ggtitle("Maximum Ac") + 
  theme_bw() +
...
ggarrange(passive_eddy, min_eddy, mean_eddy, max_eddy)
```
...
```{r path plots, warning=FALSE, message=FALSE, echo=FALSE}
