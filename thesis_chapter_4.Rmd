...
summer_heatmap_surface <- ggplot() +
  ...
  scale_fill_continuous(type = "viridis", limits = c(1, 100000)) +
...
autumn_heatmap_surface <- ggplot() +
  ...
  scale_fill_continuous(type = "viridis", limits = c(1, 110000)) +
  geom_polygon(data = south_africa_coast_hi_res, aes(x = lon, y = lat, group = PID),
               size = 0.4, colour = "black", fill = "gray") +
...
```{r message=FALSE, echo=FALSE, include=TRUE, warning=FALSE, fig.height=8, fig.width=6}

ggarrange(summer_heatmap_surface, summer_heatmap_sink, autumn_heatmap_surface, autumn_heatmap_sink, winter_heatmap_surface, winter_heatmap_sink, autumn_heatmap_surface, spring_heatmap_sink,common.legend = TRUE, font.label = list(size = 12, face = "bold"), legend = c("bottom"), ncol = 2, nrow = 4)


```

# Point plots
## Depth and surface distribution
