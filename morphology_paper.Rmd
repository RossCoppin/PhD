...
```{r map study sites, echo=FALSE, fig.height=5, fig.width=5, message=FALSE, warning=FALSE}
library(png)
library(grid)
...
```{r schematic, echo=FALSE, fig.cap='Schematic of *L. pallida* and *E. maxima* morphology [@Dyer2018-rv].', fig.height=6, fig.width=6}
...
```{r wave rose figure, echo=FALSE, warning = FALSE, eval= TRUE, fig.cap='Wave rose figure'}
