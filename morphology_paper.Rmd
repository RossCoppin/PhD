...
```{r map study sites, echo=FALSE, fig.height=8, fig.width=8, message=FALSE, warning=FALSE, fig.cap="\\label{fig:map study sites}Map of the study area and sampling sites. The red dot indicates the position of Cape Town for sake of reference."}
map_combined
```
...
schematic <- readJPEG("figures/kelp_diagram.jpg")
...
img_wave_rose_A <- rasterGrob(as.raster(readJPEG("figures/frontiers_fig_prep/fig_5A.jpg")))
img_wave_rose_B <- rasterGrob(as.raster(readJPEG("figures/frontiers_fig_prep/fig_5B.jpg")))
img_wave_rose_C <- rasterGrob(as.raster(readJPEG("figures/frontiers_fig_prep/fig_5C.jpg")))
...
wp_1 <- rasterGrob(as.raster(readJPEG("figures/frontiers_fig_prep/fig_6A.jpg")))
wp_2 <- rasterGrob(as.raster(readJPEG("figures/frontiers_fig_prep/fig_6B.jpg")))
wp_3 <- rasterGrob(as.raster(readJPEG("figures/frontiers_fig_prep/fig_6C.jpg")))
wp_4 <- rasterGrob(as.raster(readJPEG("figures/frontiers_fig_prep/fig_6D.jpg")))
wp_5 <- rasterGrob(as.raster(readJPEG("figures/frontiers_fig_prep/fig_6E.jpg")))
wp_6 <- rasterGrob(as.raster(readJPEG("figures/frontiers_fig_prep/fig_6_legend.jpg")))
