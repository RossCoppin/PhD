...
```{r wave power map, echo=FALSE, fig.cap='wave power maps'}
library(png)
library(grid)
...
```{r shallow ecklonia temp plots, echo=FALSE, message=FALSE, warning=FALSE, fig.cap ='Boxplot of morphological characteristics for shallow population *E. maxima* grouped by temperature regime.',fig.height=8, fig.width=8, include=TRUE}
ggarrange(EST1,EST2,EST3,EST4,EST5,EST6,EST7,EST8,EST9,EST10, labels = "AUTO", common.legend = FALSE, legend = "bottom")
```

```{r echo=FALSE, warning=FALSE, warning=FALSE, fig.cap ='Boxplot of morphological characteristics for shallow population *E. maxima* grouped by wave exposure.',fig.height=8, fig.width=8, include=TRUE}
ggarrange(ESW1,ESW2,ESW3,ESW4,ESW5,ESW6,ESW7,ESW8, ESW9, labels = "AUTO", common.legend = TRUE, legend = "bottom")
```

```{r rda analysis lamanaria, eval=FALSE, include=TRUE}
...
meta_lam_rda <- merge(lam_sites, meta_all, by = "site")
meta_lam_rda <- lam_meta_rda[-c(9), ] #remove Miller's point as it is dropping during processing
...
```{r rda plots, echo=FALSE, message=FALSE, warning=FALSE}
lam_rda
```
