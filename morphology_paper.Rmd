...
```{r schematic, echo=FALSE, fig.cap='Schematic of *L. pallida* and *E. maxima* morphology.', fig.height=6, fig.width=6}
...
```{r rda eck plots, echo=FALSE, fig.height=7, fig.width=9, message=FALSE, warning=FALSE}
