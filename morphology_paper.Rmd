...
```{r rda plots, echo=FALSE, fig.height=7, fig.width=7, message=FALSE, warning=FALSE}
ggarrange(lam_rda, rda_eck_deep, rda_eck_shallow, ncol = 1, nrow = 3, label = "AUTO")
lam_rda
rda_eck_deep
rda_eck_shallow
```
