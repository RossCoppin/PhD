...
wp_1 <- rasterGrob(as.raster(readPNG("figures/CapePen_Total.PNG")))
wp_2 <- rasterGrob(as.raster(readPNG("figures/CapePen_Summer.PNG")))
wp_3 <- rasterGrob(as.raster(readPNG("figures/CapePen_Winter.PNG")))
wp_4 <- rasterGrob(as.raster(readPNG("figures/CapePen_Spring.PNG")))
wp_5 <- rasterGrob(as.raster(readPNG("figures/CapePen_Autumn.PNG")))
wp_6 <- rasterGrob(as.raster(readPNG("figures/CapePen_Legend.PNG")))
