...
ggarrange(temp_plot, temp_boxplot, common.legend = FALSE, ncol = 1, nrow = 2, labels = c("AUTO"), align = c("h"), legend = c("bottom"))
```
...
wave_boxplot_2 <- ggplot(data = wave_ann_meta, aes(x = region, y = tp_mean, fill  = region)) + 
  geom_boxplot() + 
  stat_compare_means(label.y = 9, label.x = 1.5) + 
  scale_fill_discrete(name="Region") +
  xlab("") + 
  ylab("") +
  ylim(8,12) + 
...
```{r appendix figure 1, echo=FALSE, message=FALSE, warning=FALSE}
...
eck_all_A <- ggplot(data = lam_data, aes(x = site, y = laminaWeight, fill = wave_exposure)) +
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank()) 
eck_all_B <- ggplot(data = lam_data, aes(x = site, y = laminaLength, fill = wave_exposure)) +
           geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
           stat_compare_means(method = "kruskal.test", label.x = 5) + 
           scale_x_discrete(limits = positionsLam) + 
           ylab("Lamina Length (cm)") + 
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank()) 
eck_all_C <- ggplot(data = lam_data, aes(x = site, y = laminaThickness, fill = wave_exposure)) +
           geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
           stat_compare_means(method = "kruskal.test", label.x = 5) + 
           scale_x_discrete(limits = positionsLam) + 
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank()) 
eck_all_D <- ggplot(data = lam_data, aes(x = site, y = stipeMass, fill = wave_exposure)) +
           geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
           stat_compare_means(method = "kruskal.test", label.x = 5) + 
           scale_x_discrete(limits = positionsLam) + 
           ylab("Stipe Mass (cm)") + 
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank()) 
eck_all_E <- ggplot(data = lam_data, aes(x = site, y = stipeLength, fill = wave_exposure)) +
           geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
           stat_compare_means(method = "kruskal.test", label.x = 5) + 
           scale_x_discrete(limits = positionsLam) + 
           ylab("Stipe Length (cm)") + 
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank()) 
eck_all_F <- ggplot(data = lam_data, aes(x = site, y = stipeDiameter, fill = wave_exposure)) +
           geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
           stat_compare_means(method = "kruskal.test", label.x = 5) + 
           scale_x_discrete(limits = positionsLam) + 
           ylab("Stipe Diameter (cm)") + 
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank()) 
eck_all_G <- ggplot(data = lam_data, aes(x = site, y = digits, fill = wave_exposure)) +
           geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
           stat_compare_means(method = "kruskal.test", label.x = 5) + 
           scale_x_discrete(limits = positionsLam) + 
           ylab("No. of Digits") + 
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank()) 
eck_all_H <- ggplot(data = lam_data, aes(x = site, y = thallusMass, fill = wave_exposure)) +
           geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
           stat_compare_means(method = "kruskal.test", label.x = 5) + 
           scale_x_discrete(limits = positionsLam) + 
           ylab("Thallus Mass (g)") + 
        ...
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank())
eck_all_I <- ggplot(data = lam_data, aes(x = site, y = totalLength, fill = wave_exposure)) +
           geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) +
           stat_compare_means(method = "kruskal.test", label.x = 5) + 
           scale_x_discrete(limits = positionsLam) + 
           ylab("Total length (cm)") + 
...
ggarrange(eck_all_A,eck_all_B,eck_all_C,eck_all_D,eck_all_E,eck_all_F,eck_all_G,eck_all_H,eck_all_I, ncol = 3, nrow = 3, common.legend = TRUE)
