...
```{r map study sites, echo=FALSE, message=FALSE, warning=FALSE}
library(png)
library(grid)
...
```{r rda plots, echo=FALSE, fig.height=9, fig.width=9, message=FALSE, warning=FALSE}
ggarrange(lam_rda, rda_eck_deep, rda_eck_shallow, common.legend = TRUE, ncol = 3, nrow = 1, legend = c("bottom"))
```
