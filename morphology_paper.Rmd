...
wave_boxplot_1 <- ggplot(data = wave_ann_meta, aes(x = region, y = hs_mean, fill  = region)) + 
  ...
  stat_compare_means(label.y =0.5 ,label.x = 2.5, label = "p.format") + 
  xlab("") + 
  ylab("") + 
  coord_flip() + 
  theme_bw()
...
wave_boxplot_2 <- ggplot(data = wave_ann_meta, aes(x = region, y = tp_mean, fill  = region)) + 
  geom_boxplot(show.legend = FALSE) + 
  stat_compare_means(label.y = 8.1, label.x = 2.5, label = "p.format") + 
  xlab("") + 
  ylab("") +
  ylim(8,12) + 
  coord_flip() + 
...
wp_2 <-  rasterGrob(as.raster(readPNG("figures/CapePen_Legend.PNG")), interpolate = FALSE)
grid.arrange(wp_1, wp_2, ncol = 2, widths = c(2,1))
...
```{r FB spectrum, echo=FALSE, eval= TRUE, fig.cap='\\label{fig:FB spectrum}False Bay wave spectrum'}
...
```{r laminaria temp plots, echo=FALSE, fig.cap='\\label{fig:lamanaria temp plots}Boxplots of *L. pallida* morphological characteristics group by temperature regime.', fig.height=8, fig.width=8, message=FALSE, warning=FALSE, eval=TRUE}
ggarrange(LT1, LT2,LT3,LT4,LT5,LT6,LT7,LT8,LT9, labels = c("AUTO"), common.legend = TRUE, legend = "bottom")
```

```{r lamanaria wave plots, echo=FALSE, fig.cap='\\label{fig:lamanaria wave plots}Boxplots of *L. pallida* morphological characteristics group by wave exposure category.', fig.height=8, fig.width=8, warning=FALSE, eval=TRUE}
...
```{r deep ecklonia temp plot, echo=FALSE, fig.cap='Boxplot of morphological characteristics for deep population *E. maxima* grouped by temperature.', fig.height=8, fig.width=8, message=FALSE, warning=FALSE, eval=TRUE}
ggarrange(ET1,ET2,ET3,ET4,ET5,ET6,ET7,ET8,ET9,ET10, labels = "AUTO", legend = FALSE, ncol = 3, nrow = 4)
```

```{r deep ecklonia wave, echo=FALSE, fig.cap='\\label{fig:deep ecklonia wave}Boxplot of morphological characteristics for deep population *E. maxima* grouped by wave exposure.', fig.height=8, fig.width=8, warning=FALSE, eval=TRUE}
...
```{r shallow ecklonia temp, echo=FALSE, fig.cap='\\label{fig:shallow ecklonia temp}Boxplot of morphological characteristics for shallow population *E. maxima* grouped by temperature regime.', fig.height=7, fig.width=8, message=FALSE, warning=FALSE, eval=TRUE}
ggarrange(EST1,EST2,EST3,EST4,EST5,EST6,EST7,EST8,EST9,EST10, labels = "AUTO", common.legend = FALSE, legend = "bottom", ncol = 3, nrow = 4)
```

```{r shallow ecklonia wave, echo=FALSE, fig.cap='\\label{fig:shallow ecklonia wave}Boxplot of morphological characteristics for shallow population *E. maxima* grouped by wave exposure.', fig.height=7, fig.width=8, warning=FALSE, eval=TRUE}
...
```{r rda plots, echo=FALSE, fig.height=8, fig.width=8, message=FALSE, warning=FALSE, eval=TRUE, fig.cap="\\label{fig:rda plots}RDA output for *L. pallida* (A), deep *E. maxima* (B) and shallow *E. maxima* (C)."}
ggarrange(lam_rda, rda_eck_deep, rda_eck_shallow, legend = "none", labels = "AUTO", ncol = 2, nrow = 2)
```
