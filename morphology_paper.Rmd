...
lam_df$wave_exposure <- factor(lam_df$wave_exposure, levels=c("Very sheltered", "Very exposed", "Moderately exposed","Fully sheltered","Extremely sheltered"), labels=c("Fully sheltered", "Extremely sheltered", "Very sheltered", "Moderately exposed", "Very exposed"))#wave exposure levels for lamanaria
...
#remove date column
abio_clim <- subset(abio_clim, select = -c(2))
